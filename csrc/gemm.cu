 ...
 */
#include <cstdint>
#include <sparseqkv/gemm/w16a16/gemm.cuh>
...
void SparseQKVGEMM(at::Tensor x_ptr, at::Tensor w_ptr, at::Tensor y_ptr, std::optional<at::Tensor> bias, int64_t sparse_q_size,
  ...
  DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(x_ptr.scalar_type(), c_type, [&] {
    ...
    auto status = SparseQKVGEMMRun<cutlass_t>(
