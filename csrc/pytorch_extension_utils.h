...
#ifdef SPARSEQKV_ENABLE_BF16
#include <cuda_bf16.h>
#endif

#ifdef SPARSEQKV_ENABLE_F16
#include <cuda_fp16.h>
#endif

#if defined(SPARSEQKV_ENABLE_FP8_E4M3) || defined(SPARSEQKV_ENABLE_FP8_E5M2)
#include <cuda_fp8.h>
#endif

#ifndef SPARSEQKV_EXT_MODULE_INITED
#define SPARSEQKV_EXT_MODULE_INITED

// To expand macros in #name
#define SPARSEQKV_EXT_MODULE_INIT_EXPAND(name) SPARSEQKV_EXT_MODULE_INIT(name)
...
/* Creates a dummy empty module that can be imported from Python.
   ...
   are run. */
#define SPARSEQKV_EXT_MODULE_INIT(name)                                  \
  extern "C" {                                                            \
...
SPARSEQKV_EXT_MODULE_INIT_EXPAND(TORCH_EXTENSION_NAME)

#undef SPARSEQKV_EXT_MODULE_INIT
#undef SPARSEQKV_EXT_MODULE_INIT_EXPAND
...
#ifdef SPARSEQKV_ENABLE_FP8_E4M3
...
#ifdef SPARSEQKV_ENABLE_FP8_E5M2
