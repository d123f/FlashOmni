#ifndef SPARSEQKV_GEMM_REDUC_CUH_
#define SPARSEQKV_GEMM_REDUC_CUH_
...
__global__ void sparseqkv_gemm_reduction_kernel(const T *Aptr, const T *Bptr,  T *bias_ptr,
...
template <typename T>
cudaError_t SparseQKVGEMMReductionRun(T* x, T* w, T* c, T* bias, 
    ...
    auto kernel = sparseqkv_gemm_reduction_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA, G2SCopyB, SmemLayoutA, SmemLayoutB, SmemLayoutC, S2RCopyAtomA, S2RCopyAtomB, R2SCopyAtomC, S2GCopyAtomC, S2GCopyC>;
    SPARSEQKV_CUDA_CALL(
