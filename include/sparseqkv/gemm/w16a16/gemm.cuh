...
__global__ void sparseqkv_gemm_kernel(const T *Aptr, const T *Bptr,  T *bias_ptr,
...
template <typename T>
cudaError_t SparseQKVGEMMRun(T* x, T* w, T* c, T* bias, 
    ...
    auto kernel = sparseqkv_gemm_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA, G2SCopyB, SmemLayoutA, SmemLayoutB, SmemLayoutC, S2RCopyAtomA, S2RCopyAtomB, R2SCopyAtomC, S2GCopyAtomC, S2GCopyC>;
    SPARSEQKV_CUDA_CALL(
