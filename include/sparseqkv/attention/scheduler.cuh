 ...
 */
#ifndef SPARSEQKV_ATTENTION_SCHEDULER_CUH_
#define SPARSEQKV_ATTENTION_SCHEDULER_CUH_
...
inline auto PrefillSplitQOKVIndptr(IdType* qo_indptr_h, IdType* kv_indptr_h,
  ...
  SPARSEQKV_CHECK(new_batch_size <= padded_batch_size,
...
inline cudaError_t PrefillPlan(void* float_buffer, size_t float_workspace_size_in_bytes,
  ...
  SPARSEQKV_CUDA_CALL(cudaDeviceGetAttribute(&num_sm, cudaDevAttrMultiProcessorCount, dev_id));
  ...
  SPARSEQKV_CUDA_CALL(cudaMemcpyAsync(int_buffer, page_locked_int_buffer, num_bytes_to_copy,
...
#endif  // SPARSEQKV_ATTENTION_SCHEDULER_CUH_
