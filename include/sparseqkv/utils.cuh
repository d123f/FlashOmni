 ...
 */
#ifndef SPARSEQKV_UTILS_CUH_
#define SPARSEQKV_UTILS_CUH_
#include <cuda_bf16.h>
...
#ifndef SPARSEQKV_ALWAYS_DISUSE_FP16_QK_REDUCTION
#define SPARSEQKV_ALWAYS_DISUSE_FP16_QK_REDUCTION 0
#endif

#ifndef NDEBUG
#define SPARSEQKV_CUDA_CALL(func, ...)                                                     \
  {                                                                                         \
    cudaError_t e = (func);                                                                 \
    if (e != cudaSuccess) {                                                                 \
...
#define DISPATCH_USE_FP16_QK_REDUCTION(use_fp16_qk_reduction, USE_FP16_QK_REDUCTION, ...) \
  if (use_fp16_qk_reduction) {                                                            \
    SPARSEQKV_ERROR("FP16_QK_REDUCTION disabled at compile time");                       \
  } else {                                                                                \
