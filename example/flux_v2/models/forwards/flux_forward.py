...
from ..cache_functions import cache_init, cal_type, cal_type_sparse

logger = logging.get_logger(__name__)

def sparsetaylorseer_flux_forward(
    ...
    # print(joint_attention_kwargs['current']['type'], joint_attention_kwargs['current']['step'])
    joint_attention_kwargs['current']['stream'] = 'double_stream'
    for index_block, block in enumerate(self.transformer_blocks):
        joint_attention_kwargs['current']['layer'] = index_block
        cal_type_sparse(joint_attention_kwargs['cache_dic'], joint_attention_kwargs['current'])
